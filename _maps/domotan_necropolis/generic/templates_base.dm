...
#define NATURAL_MICRO_TEMPLATES list("small_generic_tile_1z_micro_animal_den", "small_generic_tile_1z_micro_animal_den_1", "small_generic_tile_1z_micro_animal_den_2", "small_generic_tile_1z_micro_animal_den_3", "small_generic_tile_1z_micro_animal_den_4", "small_generic_tile_1z_micro_animal_den_5")
...
/datum/map_template/dungeon/small_generic_tile_1z_micro_animal_den
	name = "Small Generic Tile (Micro Animal Den)"
	id = "small_generic_tile_1z_micro_animal_den"
	mappath = "_maps/domotan_necropolis/generic/natural/micro_animal_den.dmm"

/datum/map_template/dungeon/small_generic_tile_1z_micro_animal_den_2
	name = "Small Generic Tile (Micro Animal Den 2)"
	id = "small_generic_tile_1z_micro_animal_den_2"
	mappath = "_maps/domotan_necropolis/generic/natural/micro_animal_den_2.dmm"

/datum/map_template/dungeon/small_generic_tile_1z_micro_animal_den_3
	name = "Small Generic Tile (Micro Animal Den 3)"
	id = "small_generic_tile_1z_micro_animal_den_3"
	mappath = "_maps/domotan_necropolis/generic/natural/micro_animal_den_3.dmm"

/datum/map_template/dungeon/small_generic_tile_1z_micro_animal_den_4
	name = "Small Generic Tile (Micro Animal Den 4)"
	id = "small_generic_tile_1z_micro_animal_den_4"
	mappath = "_maps/domotan_necropolis/generic/natural/micro_animal_den_4.dmm"

/datum/map_template/dungeon/small_generic_tile_1z_micro_animal_den_5
	name = "Small Generic Tile (Micro Animal Den 5)"
	id = "small_generic_tile_1z_micro_animal_den_5"
