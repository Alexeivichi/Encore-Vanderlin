...
/obj/item/weapon/shield/tower/metal/psy
	name = "Covenant"
	desc = "The Inquisition's Knightly Chapter holds a mantra: An Inquisitor endures. An Inquisitor preserves themselves. An Inquisitor preserves His flock. Protect them."
