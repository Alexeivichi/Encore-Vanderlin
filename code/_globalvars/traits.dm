...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"Member of the Katholikos' Inquisition" = TRAIT_INQUISITION,
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_INQUISITION = span_info("I am a member of the Katholikos'. I can easily identify others of my cadre at a glance."),
