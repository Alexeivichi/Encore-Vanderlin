...
/datum/anvil_recipe/armor/steel/templar/helmet_akan
...
/datum/anvil_recipe/armor/steel/templar/helmet_golerkanh
	name = "Goler Kahn Helmet (+Iron Bar)"
...
/datum/anvil_recipe/armor/steel/templar/helmet_mjallidhorn
	name = "Mjallidhorn Helmet (+Bronze Bar)"
	created_item = /obj/item/clothing/head/helmet/heavy/necked/mjallidhorn
	additional_items = list(/obj/item/ingot/bronze)
...
/datum/anvil_recipe/armor/blessedsilver/angroschestplate
	name = "Angrosian Chestplate (+1 Cured Leather)"
	required_material = /obj/item/ingot/silverblessed
	additional_items = list(/obj/item/natural/hide/cured)
	created_item = /obj/item/clothing/armor/cuirass/angros

/datum/anvil_recipe/armor/blessedsilver/angroscuirass
	name = "Angrosian Cuirass (+2 Cured Leather)"
	required_material = /obj/item/ingot/silverblessed
	additional_items = list(/obj/item/natural/hide/cured, /obj/item/natural/hide/cured)
	created_item = /obj/item/clothing/armor/cuirass/ornate

/datum/anvil_recipe/armor/blessedsilver/armetangros
	name = "Angrosian Armet"
	required_material = /obj/item/ingot/silverblessed
	created_item = /obj/item/clothing/head/helmet/heavy/angroshelm

/datum/anvil_recipe/armor/blessedsilver/helmsallangros
	name = "Angrosian Sallet (+1 Blessed Silver)"
	required_material = /obj/item/ingot/silverblessed
	created_item = /obj/item/clothing/head/helmet/heavy/psysallet

/datum/anvil_recipe/armor/blessedsilver/helmbucketangros
	name = "Angrosian Bucket Helm (+1 Blessed Silver)"
	required_material = /obj/item/ingot/silverblessed
...
/datum/anvil_recipe/armor/blessedsilver/angroshalfplate
	name = "Angrosian Half-Plate (+Angrosian Cuirass, +1 Blessed Silver, +2 Cured Leather)"
	required_material = /obj/item/ingot/silverblessed
...
/datum/anvil_recipe/armor/blessedsilver/angrosfullplate
	name = "Angrosian Full-Plate (+Angrosian Half-Plate, +1 Blessed Silver, +2 Cured Leather)"
	required_material = /obj/item/ingot/silverblessed
...
/datum/anvil_recipe/armor/blessedsilver/angrosfullplatealt
	name = "Angrosian Full-Plate, Hauberked (+Angrosian Hauberk, +2 Blessed Silver, +2 Cured Leather)"
	required_material = /obj/item/ingot/silverblessed
...
/datum/anvil_recipe/armor/blessedsilver/angrosian_gloves
