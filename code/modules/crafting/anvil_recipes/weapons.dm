...
/datum/anvil_recipe/weapons/psy/axe
	name = "Angrosian War Axe (+B. Silver, +Stick)"
...
/datum/anvil_recipe/weapons/psy/mace
	name = "Angrosian Mace (+B. Silver, +Stick)"
	required_material = /obj/item/ingot/silverblessed
	craftdiff = 3
...
/datum/anvil_recipe/weapons/psy/spear
	name = "Angrosian Spear (+Small Log)"
	required_material = /obj/item/ingot/silverblessed
	craftdiff = 3
...
/datum/anvil_recipe/weapons/psy/halberd
	name = "Angrosian Halberd (+B. Silver, +Small Log)"
	required_material = /obj/item/ingot/silverblessed
	craftdiff = 3
...
/datum/anvil_recipe/weapons/psy/gsword
	name = "Angrosian Greatsword (+B. Silver)"
	required_material = /obj/item/ingot/silverblessed
	craftdiff = 3
...
/datum/anvil_recipe/weapons/psy/whip
	name = "Angrosian Whip (+Cured Leather x2)"
	required_material = /obj/item/ingot/silverblessed
	craftdiff = 3
