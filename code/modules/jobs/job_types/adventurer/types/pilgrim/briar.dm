...
/obj/item/gani_blessing/interact_with_atom(atom/interacting_with, mob/living/user, list/modifiers)
	...
	if(!istype(user.patron, /datum/patron/divine/gani) || !check_blessing_requirements(user))
