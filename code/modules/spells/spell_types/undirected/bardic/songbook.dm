...
/datum/songbook_ui/ui_data(mob/user)
	...
	var/list/buff_options = list(
		list("path" = /datum/status_effect/bardicbuff/intelligence, "name" = "Akan's Brilliance", "desc" = "+1 INT", "min_level" = 1),
		list("path" = /datum/status_effect/bardicbuff/endurance, "name" = "Goler Kanh's Resilience", "desc" = "+1 END", "min_level" = 2),
		list("path" = /datum/status_effect/bardicbuff/constitution, "name" = "Erdl's Blessing", "desc" = "+1 CON", "min_level" = 3),
		list("path" = /datum/status_effect/bardicbuff/speed, "name" = "Iliope's Alacrity", "desc" = "+1 SPD", "min_level" = 4),
		list("path" = /datum/status_effect/bardicbuff/mordsol, "name" = "Mordsol's Righteous Fury", "desc" = "+1 STR, +1 PER", "min_level" = 5),
		list("path" = /datum/status_effect/bardicbuff/awaken, "name" = "Visires' Awakening", "desc" = "+energy, +stamina, +1 FOR", "min_level" = 6),
	)
	...
	switch(action)
		...
		if("toggle_buff")
			...
			var/list/min_levels = list(
				...
				/datum/status_effect/bardicbuff/mordsol = 5,
