...
/obj/item/clothing/armor/cuirass/fluted/gold/heroic
	...
	desc = "A resplendant cuirass of pure gold, fitted with tassets for additional coverage. It has been meticulously waxed-and-assembled from dozens of smaller golden plates, in order to replicate the statuesque physique of the Goblet's legendary heroes."
